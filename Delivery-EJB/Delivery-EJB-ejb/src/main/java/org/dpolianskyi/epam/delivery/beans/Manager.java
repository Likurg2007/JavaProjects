...
import org.dpolianskyi.epam.delivery.paging.PageController;
import org.dpolianskyi.epam.delivery.paging.PagesNS;
import org.dpolianskyi.epam.delivery.paging.Pagination;
...
public class Manager {
    ...
    @PostConstruct
    public void init() {
        requestJPAController = new RequestDAO();
        curProductJPAController = new CurProductDAO();
        curPro_RequestJPAController = new Curpro_RequestDAO();
    ...
    public DataModel<Request> getModelRequest() {
        System.out.println("GET_MODEL_REQUEST");
        try {
